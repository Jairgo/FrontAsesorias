...
import MateriaList from '../items/MateriaList';
function AsesorRequest (){
    const [modalVisible, setModalVisible] = useState(false);
    return(
        <View style={styles.screen}>
            <Text style={{fontSize: 30}}>Solicitud</Text>
            <Text style={styles.text}>
                Para ser asesor requieres especificar en que materias puedas impartir y el comite y una 
                descripción sobre tus habilidades, el comite evaluará si tienes las capacidades para impartir 
                las materias y te permitirán ser asesor.
            </Text>
